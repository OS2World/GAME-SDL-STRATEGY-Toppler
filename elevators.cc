...
void ele_select(Uint16 row, Uint8 col) {
  ...
  assert(active_ele == -1, _("Select more than one elevator."));
...
void ele_activate(Sint8 dir) {
  ...
  assert(active_ele != -1, _("Work with unselected elevator, activate."));
...
void ele_move(void) {
  ...
  assert(active_ele != -1, _("Work with unselected elevator, move."));
...
bool ele_is_atstop(void) {
  ...
  assert(active_ele != -1, _("Work with unselected elevator, is_atstop."));
...
void ele_deactivate(void) {
  ...
  assert(active_ele != -1, _("Deselected an inactive elevator."));
