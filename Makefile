...
_build/sprites.dat: _build/tools/sprites _build/tools/assembler _build/tools/colorreduction \
	...
	( cd _build/sprites_pov && mkdir -p balls && cd balls && $(POVRAY) ../../../datafile/sprites_pov/balls/obj.ini  +L../../../datafile/sprites_pov/balls -D )
	( cd _build/sprites_pov && mkdir -p box && cd box && $(POVRAY) ../../../datafile/sprites_pov/box/obj.ini +L../../../datafile/sprites_pov/box -D )
